...
#' 
A3Model2_specification0<-function(region) {
...
if (region==1) {
  ...
  vlist2<-paste0("+rankdrive",
                 "+I(drive_BAN*(rankdrive_BAN==1))",
                 "+I(drive_BAN*(rankdrive_BAN==2))",
                 "+I(drive_BAN*(rankdrive_BAN==3))",
                 "+I(drive_GHM*(rankdrive_GHM==1))",
                 "+I(drive_GHM*(rankdrive_GHM==2))",
                 "+I(drive_GHM*(rankdrive_GHM==3))",
                 "+I(drive_SFD*(rankdrive_SFD==1))",
                 "+I(drive_SFD*(rankdrive_SFD==2))",
                 "+I(drive_SFD*(rankdrive_SFD==3))",
                 "+I(drive_PEAK*(rankdrive_PEAK==1))",
                 "+I(drive_PEAK*(rankdrive_PEAK==2))",
                 "+I(drive_PEAK*(rankdrive_PEAK==3))",
                 "+I(drive_WBR*(rankdrive_WBR==1))",
                 "+I(drive_WBR*(rankdrive_WBR==2))",
                 "+I(drive_WBR*(rankdrive_WBR==3))",
                 "+I(drive_OAD*(rankdrive_OAD==1))",
                 "+I(drive_OAD*(rankdrive_OAD==2))",
                 "+I(drive_OAD*(rankdrive_OAD==3))")

  vlist3<-paste0("+ranktrans",
                 "+I((ranktrans_DBY==1)*trans_DBY)",
                 "+I((ranktrans_DBY==2)*trans_DBY)",
                 "+I((ranktrans_DBY==3)*trans_DBY)",
                 "+I((ranktrans_LEI==1)*trans_LEI)",
                 "+I((ranktrans_LEI==2)*trans_LEI)",
                 "+I((ranktrans_LEI==3)*trans_LEI)",
                 "+I((ranktrans_LIN==1)*trans_LIN)",
                 "+I((ranktrans_LIN==2)*trans_LIN)",
                 "+I((ranktrans_LIN==3)*trans_LIN)",
                 "+I((ranktrans_NOT==1)*trans_NOT)",
                 "+I((ranktrans_NOT==2)*trans_NOT)",
                 "+I((ranktrans_NOT==3)*trans_NOT)",
                 "+I((ranktrans_SHF==1)*trans_SHF)",
                 "+I((ranktrans_SHF==2)*trans_SHF)",
                 "+I((ranktrans_SHF==3)*trans_SHF)")
} else if (region==4) {
  vlist2<-paste0("+rankdrive",
  ...
  vlist2<-paste0("+rankdrive",
                 "+I(drive_DON*(rankdrive_DON==1))+I(drive_DON*(rankdrive_DON==2))",
                 "+I(drive_DON*(rankdrive_DON==3))",
                 "+I(drive_HRG*(rankdrive_HRG==1))+I(drive_HRG*(rankdrive_HRG==2))",
                 "+I(drive_HRG*(rankdrive_HRG==3))",
                 "+I(drive_KSN*(rankdrive_KSN==1))+I(drive_KSN*(rankdrive_KSN==2))",
                 "+I(drive_KSN*(rankdrive_KSN==3))",
                 "+I(drive_OSM*(rankdrive_OSM==1))+I(drive_OSM*(rankdrive_OSM==2))",
                 "+I(drive_OSM*(rankdrive_OSM==3))",
                 ...
                 "+I(drive_SCU*(rankdrive_SCU==1))+I(drive_SCU*(rankdrive_SCU==2))",
                 "+I(drive_SCU*(rankdrive_SCU==3))",
                 "+I(drive_SKP*(rankdrive_SKP==1))+I(drive_SKP*(rankdrive_SKP==2))",
                 "+I(drive_SKP*(rankdrive_SKP==3))",
                 "+I(drive_DRF*(rankdrive_DRF==1))+I(drive_DRF*(rankdrive_DRF==2))",
                 "+I(drive_DRF*(rankdrive_DRF==3))")

  vlist3<-paste0("+ranktrans",
                 "+I((ranktrans_KSN==1)*trans_KSN)",
                 "+I((ranktrans_KSN==2)*trans_KSN)",
                 "+I((ranktrans_KSN==3)*trans_KSN)",
                 "+I((ranktrans_LDS==1)*trans_LDS)",
                 "+I((ranktrans_LDS==2)*trans_LDS)",
                 "+I((ranktrans_LDS==3)*trans_LDS)",
                 "+I((ranktrans_SHF==1)*trans_SHF)",
                 "+I((ranktrans_SHF==2)*trans_SHF)",
                 "+I((ranktrans_SHF==3)*trans_SHF)",
                 "+I((ranktrans_YRK==1)*trans_YRK)",
                 "+I((ranktrans_YRK==2)*trans_YRK)",
                 "+I((ranktrans_YRK==3)*trans_YRK)",
                 "+I((ranktrans_MBH==1)*trans_MBH)",
                 "+I((ranktrans_MBH==2)*trans_MBH)",
                 "+I((ranktrans_MBH==3)*trans_MBH)")
} # if (region==1) 
