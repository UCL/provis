#' A4CreateSettlement(region,dirs,filename,title,outfile,m2data_new)
...
#' @export
#' @examples
#' newdata <- A4CreateSettlement(region = 1,dirs,filename = "Bedford.csv",title,outfile)
#' newdata <- A4CreateSettlement(region = 1,dirs,m2data_new = m2data_base)
A4CreateSettlement<-function(region,dirs,filename,m2data_new,depvar="logvalue",travelmodelbasis="cheb",
