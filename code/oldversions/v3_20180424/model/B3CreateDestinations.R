...
#  raildest<-c(2,3,6,7,8,11:16)
  ...
  dest_name<-c("Barnstaple, England",
               ...
               "Exeter Airport, UK",
               "Newquay Airport, UK")
  dest_name_short<-c("BSP","BUD","DMR","EXE","EXM","FAL","NQY","MHD","PAD","PNZ",
                     "PLY","RED","STA","SIV","TAU","TBY","TRU",
                     "EXE_AIR","NQY_AIR")
  idest<-c(1,4,8,9,10,11,13,14,16)
  raildest<-c(1,4,10,11,14,15,16,17)
  airport<-c(18,19)
} else if (region_id==3) {
  # East Midlands
  ...
  dest_name_short<-c("BAN","BIR","COV","DBY","GHM","LEI","LIN","NHN","NOT",
                     "PBH","SHF","SFD","EMA","PEAK","WBR","OAD","DAV")
#  idest<-c(1:11)
