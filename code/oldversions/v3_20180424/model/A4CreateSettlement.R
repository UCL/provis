...
A4CreateSettlement<-function(region_id,dirs,filename,m2data_new,travelmodelbasis="cheb",
  ...
  m2data_new<-A2Model2_newvariables(m2data_new,dest,convexhull,region_id,dirs,
