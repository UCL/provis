...
#' @param region_polygon polygon for region (bounding box or convexhull)
...
FindNearestRoad<-function(houses,region_polygon,roadtype="motorways",region_id,dirs,basis="glp") {
...
#  houses_convexhull<-gConvexHull(houses)
  ...
  i1<-gIntersects(roads,region_polygon,byid=TRUE)
