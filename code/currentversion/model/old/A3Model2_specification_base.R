...
if (region==1) {
  ...
  vlist2<-paste0("+rankavgtime",
                 ...
                 "+I(avgtime_BEA*(rankavgtime_BEA==1))+I(avgtime_BEA*(rankavgtime_BEA==2))",
                 "+I(avgtime_BEA*(rankavgtime_BEA==3))",
                 ...
                 "+I(avgtime_LNE*(rankavgtime_LNE==1))+I(avgtime_LNE*(rankavgtime_LNE==2))",
                 "+I(avgtime_LNE*(rankavgtime_LNE==3))",
                 "+I(avgtime_KGC*(rankavgtime_KGC==1))+I(avgtime_KGC*(rankavgtime_KGC==2))",
                 "+I(avgtime_KGC*(rankavgtime_KGC==3))",
                 "+I(avgtime_OXF*(rankavgtime_OXF==1))+I(avgtime_OXF*(rankavgtime_OXF==2))",
                 "+I(avgtime_OXF*(rankavgtime_OXF==3))",
                 "+I(avgtime_OXT*(rankavgtime_OXT==1))+I(avgtime_OXT*(rankavgtime_OXT==2))",
                 "+I(avgtime_OXT*(rankavgtime_OXT==3))",
                 "+I(avgtime_SAL*(rankavgtime_SAL==1))+I(avgtime_SAL*(rankavgtime_SAL==2))",
                 "+I(avgtime_SAL*(rankavgtime_SAL==3))",
                 "+I(avgtime_SOU*(rankavgtime_SOU==1))+I(avgtime_SOU*(rankavgtime_SOU==2))",
                 "+I(avgtime_SOU*(rankavgtime_SOU==3))",
                 "+I(avgtime_STP*(rankavgtime_STP==1))+I(avgtime_STP*(rankavgtime_STP==2))",
                 "+I(avgtime_STP*(rankavgtime_STP==3))",
                 "+I(avgtime_WFD*(rankavgtime_WFD==1))+I(avgtime_WFD*(rankavgtime_WFD==2))",
                 "+I(avgtime_WFD*(rankavgtime_WFD==3))")
